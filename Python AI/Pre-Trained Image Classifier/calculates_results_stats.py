...
def calculates_results_stats(results_dic):
    ...
    results_stats_dic['pct_match'] = (results_stats_dic['n_match'] / float(results_stats_dic['n_images'])) * 100

    results_stats_dic['pct_correct_dogs'] = (results_stats_dic['n_correct_dogs'] / float(
        results_stats_dic['n_dogs_img'])) * 100

    results_stats_dic['pct_correct_breed'] = (results_stats_dic["n_correct_breed"] / float(
        results_stats_dic["n_dogs_img"])) * 100

    if results_stats_dic['n_notdogs_img'] > 0:
        results_stats_dic['pct_correct_notdogs'] = (results_stats_dic['n_correct_notdogs'] / float(results_stats_dic[
            'n_notdogs_img'])) * 100.0
    else:
        results_stats_dic['pct_correct_notdogs'] = 0.0
